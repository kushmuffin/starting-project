        ...
        <tbody>
          {comparisResultsData.map((yearData) => {
            const comparisInitialInvestment =
              comparisResultsData[0].valueEndOfYear -
              comparisResultsData[0].interest -
              comparisResultsData[0].annualInvestment;
            const comparisTotalInterest =
              yearData.valueEndOfYear -
              yearData.annualInvestment * yearData.year -
              comparisInitialInvestment;
            const comparisTotalAmountInvested =
              yearData.valueEndOfYear - comparisTotalInterest;
